...
rm -rf "$DIR"/spider.jar/smali/com/github/catvod/api
rm -rf "$DIR"/spider.jar/smali/com/github/catvod/bean
...
cp -rf "$DIR"/Smali_classes/com/github/catvod/api "$DIR"/spider.jar/smali/com/github/catvod/
cp -rf "$DIR"/Smali_classes/com/github/catvod/bean "$DIR"/spider.jar/smali/com/github/catvod/
